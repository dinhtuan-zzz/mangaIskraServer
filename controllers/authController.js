...
let transporter = nodemailer.createTransport({
  ...
  service: "Gmail",
  auth: {
    user: "maidinhtuan1234567@gmail.com",
    pass: "xmgkeodwhyfoozoi",
  },
});
var otp = Math.random();
otp = otp * 1000000;
...
export const authMail = async (req, res, next) => {
  ...
  try {
    ...
    if (user.length === 0) {
      var mailOptions = {
        from: "maidinhtuan1234567@gmail.com",
        to: email,
        subject:
          "Chào mừng bạn đến với Speirum | Mạng xã hội chia sẻ quan điểm ",
        html:
          "<h3>Mã OTP để xác thực của bạn là: </h3>" +
